// StatisticsModels.cs — request/response shapes for the Statistics page and its child
// components. Client-local (not shared with the server project) — moved out of
// Statistics.razor's @code block so multiple components under StatisticsChildComponents/
// can reference them without each pulling in the whole page.
namespace EcaInformationSystem.Client.Pages.Statistics
{
