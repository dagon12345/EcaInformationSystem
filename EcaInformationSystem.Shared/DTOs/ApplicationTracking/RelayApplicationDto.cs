namespace EcaInformationSystem.Shared.DTOs.ApplicationTracking
{
    ...
    // original creator).
    public class RelayApplicationDto
    {
    ...
    public class ReturnApplicationForFindingsDto
    {
        public Guid ToUserId { get; set; }
        public string? Note { get; set; }
    ...
    public class RelayApplicationNoteDto
    {
        public string? Note { get; set; }
        public bool IsFinding { get; set; }
        public string? FindingJustification { get; set; }
    ...
    // workflow stage.
    public class UpdateApplicationTransferNoteDto
    {
        public string? Note { get; set; }
        public bool IsFinding { get; set; }
        public string? FindingJustification { get; set; }
