...
namespace EcaInformationSystem.Infrastructure.Migrations
{
    ...
    [Migration("20260923013107_AddPlatformUsedToBeneficiary")]
    partial class AddPlatformUsedToBeneficiary
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EcaInformationSystem.Domain.Entities.ApplicationBatch", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("EcaInformationSystem.Domain.Entities.ApplicationGranteeRow", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("ApplicationBatchId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("ApplicationBatchId");

                    b.ToTable("ApplicationGranteeRows");
                });

            modelBuilder.Entity("EcaInformationSystem.Domain.Entities.ApplicationTransfer", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("ApplicationTransfers");
                });
            ...
            modelBuilder.Entity("EcaInformationSystem.Domain.Entities.BeneficiaryInformation", b =>
                {
                    ...
                    b.Property<string>("PlatformUsed")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("EcaInformationSystem.Domain.Entities.DtrPunchEditRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<DateTime?>("RequestedPunchDateTime")
                        .HasColumnType("datetime2");
                    ...
                    b.ToTable("DtrPunchEditRequests");
                });
            ...
            modelBuilder.Entity("EcaInformationSystem.Domain.Entities.LeaderboardSeason", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("LeaderboardSeasons", (string)null);
                });

            modelBuilder.Entity("EcaInformationSystem.Domain.Entities.LivenessCheckRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("EcaInformationSystem.Domain.Entities.Log", b =>
                {
                    ...
                    b.Property<Guid?>("NcscTeamDirectoryEntryId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("NcscTeamDirectoryEntryId")
            ...
            modelBuilder.Entity("EcaInformationSystem.Domain.Entities.NcscTeamDirectoryEntry", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("IsDeleted", "PsgcCodeRegion")
                        .HasDatabaseName("IX_NcscTeamDirectory_Region");

                    b.ToTable("NcscTeamDirectoryEntries");
                });
            ...
            modelBuilder.Entity("EcaInformationSystem.Domain.Entities.PendingUserRegistration", b =>
                {
                    ...
                    b.Property<int?>("LastBirthdayGreetedYear")
                        .HasColumnType("int");

                    b.Property<int?>("LastSeasonNumber")
                        .HasColumnType("int");

                    b.Property<int?>("LastSeasonRank")
                        .HasColumnType("int");

                    b.Property<int?>("LastSeasonTransactionCount")
                        .HasColumnType("int");

                    b.Property<DateTime?>("LastSeenAt")
                        .HasColumnType("datetime2");

                    b.Property<int>("LeaderboardTotalWins")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EcaInformationSystem.Domain.Entities.PostEntities.Post", b =>
                {
                    ...
                    b.Property<int?>("BirthdayTurningAge")
                        .HasColumnType("int");

                    b.Property<Guid?>("BirthdayUserId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<string>("BirthdayUserName")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("PodiumDataJson")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("EcaInformationSystem.Domain.Entities.PublicPageView", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("EcaInformationSystem.Domain.Entities.ApplicationGranteeRow", b =>
                {
                    b.HasOne("EcaInformationSystem.Domain.Entities.ApplicationBatch", "ApplicationBatch")
                        .WithMany("Rows")
                        .HasForeignKey("ApplicationBatchId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("ApplicationBatch");
                });
