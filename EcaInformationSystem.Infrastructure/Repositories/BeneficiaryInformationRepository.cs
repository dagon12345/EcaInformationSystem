            ...
            report.ProvinceBreakdowns = provinceGroups
                .Select(g =>
                {
                    ...
                    return new ProvinceStatisticsDto
                    {
                        ...
                        Age80LivenessCount = items.Count(b => ComputeAge(b.BirthDate) >= 80 && ComputeAge(b.BirthDate) < 85 && b.IsLivenessVerified == true),
                        Age80EftReadyCount = items.Count(b => ComputeAge(b.BirthDate) >= 80 && ComputeAge(b.BirthDate) < 85 && b.IsReadyForEft == true),
                        Age85LivenessCount = items.Count(b => ComputeAge(b.BirthDate) >= 85 && ComputeAge(b.BirthDate) < 90 && b.IsLivenessVerified == true),
                        Age85EftReadyCount = items.Count(b => ComputeAge(b.BirthDate) >= 85 && ComputeAge(b.BirthDate) < 90 && b.IsReadyForEft == true),
                        Age90LivenessCount = items.Count(b => ComputeAge(b.BirthDate) >= 90 && ComputeAge(b.BirthDate) < 95 && b.IsLivenessVerified == true),
                        Age90EftReadyCount = items.Count(b => ComputeAge(b.BirthDate) >= 90 && ComputeAge(b.BirthDate) < 95 && b.IsReadyForEft == true),
                        Age95LivenessCount = items.Count(b => ComputeAge(b.BirthDate) >= 95 && ComputeAge(b.BirthDate) < 100 && b.IsLivenessVerified == true),
                        Age95EftReadyCount = items.Count(b => ComputeAge(b.BirthDate) >= 95 && ComputeAge(b.BirthDate) < 100 && b.IsReadyForEft == true),
                        Age100LivenessCount = items.Count(b => ComputeAge(b.BirthDate) >= 100 && b.IsLivenessVerified == true),
                        Age100EftReadyCount = items.Count(b => ComputeAge(b.BirthDate) >= 100 && b.IsReadyForEft == true),
