...
{
    // Push-only — no client-invokable methods. DocumentTrackingController pushes
    // "DocumentTagged" to Clients.User(taggedUserId) whenever a batch's
    ...
    [Authorize]
    public class DocumentTrackingHub : Hub
    {
    }
}
